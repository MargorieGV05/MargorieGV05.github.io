...
createCollectable("steve", 200, 170, 6, 0.7);
    // TODO 1
    // Create platforms
    createPlatform(150, 720, 150, 200); 
    ...
    createPlatform(730,190,190,40);
   createPlatform(390, 200,80,40);
    ...
    createCannon("bottom", 990, 1000, 80, 20);
    createCannon("top", 880, 1000, 80, 20 );
